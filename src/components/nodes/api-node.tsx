...
export function APINode({ id, data, selected }: NodeProps) {
  ...
  const urlStr = (data?.url as string) || (data?.endpoint as string) || "https://api.example.com";
  ...
  return (
    ...
    >
      ...
      <Handle
        ...
        className="!w-3 !h-3 !bg-[#185FA5] !border-2 !border-background hover:!scale-125 transition-transform"
      />
      ...
      <div className="flex items-start justify-between gap-3 p-3.5 pb-2">
        <div className="flex items-start gap-2.5 min-w-0 text-left">
          ...
          >
            <Globe size={18} weight="fill" style={{ color: "#185FA5" }} />
          </div>
